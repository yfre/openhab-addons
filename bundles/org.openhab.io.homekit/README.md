...
|                    | AirQuality   |                              | String                    | Air quality state, possible values (UNKNOWN,EXCELLENT,GOOD,FAIR,INFERIOR,POOR). Custom mapping can be defined using HomeKit addon settings or metadata at item level        |
