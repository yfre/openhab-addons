...
|                      | AirQuality   |                              | String                    | Air quality state, possible values (UNKNOWN,EXCELLENT,GOOD,FAIR,INFERIOR,POOR). Mapping can be redefined at item level, e.g. [EXCELLENT="VERY GOOD", POOR="BAD"]         |
...
|                      | ActiveStatus                |                              | Switch, Contact         | accessory current working status. A value of "ON"/"OPEN" indicate that the accessory is active and is functioning without any errors.                                                                                                                                                                     |
|                      | CurrentAirPurifierState    |                              | String                   | current air purifier mode (INACTIVE, IDLE, PURIFYING). Mapping can be redefined at item level, e.g. [INACTIVE="OFF", PURIFYING="ACTIVE"]                                                                                                                                                            |
...
|                      | OccupancyDetectedState      |                              | SwitchItem, Contact  | Occupancy sensor state (ON=occupied, OFF=not occupied                                                                                                                                                                                                                                                     |
|                      |                             | Name                         | String                   | Name of the sensor                                                                                                                                                                                                                                                                                        |
|                      |                             | ActiveStatus                 | Switch, Contact          | accessory current working status. A value of "ON"/"OPEN" indicate that the accessory is active and is functioning without any errors.                                                                                                                                                                     |
|                      |                             | FaultStatus                  | Switch, Contact          | accessory fault status.  "ON"/"OPEN" value indicates that the accessory has experienced a fault that may be interfering with its intended functionality. A value of "OFF"/"CLOSED" indicates that there is no fault.                                                                                      |
|                      |                             | TamperedStatus               | Switch, Contact          | accessory tampered status. A status of "ON"/"OPEN" indicates that the accessory has been tampered with. Value should return to "OFF"/"CLOSED" when the accessory has been reset to a non-tampered state.                                                                                                  |
...
|                      | ContactSensorState          |                              | SwitchItem, Contact  | Contact sensor state (ON=open, OFF=closed)                                                                                                                                                                                                                                                                |
|                      |                             | Name                         | String                   | Name of the sensor                                                                                                                                                                                                                                                                                        |
|                      |                             | ActiveStatus                 | Switch, Contact          | accessory current working status. A value of "ON"/"OPEN" indicate that the accessory is active and is functioning without any errors.                                                                                                                                                                     |
|                      |                             | FaultStatus                  | Switch, Contact          | accessory fault status.  "ON"/"OPEN" value indicates that the accessory has experienced a fault that may be interfering with its intended functionality. A value of "OFF"/"CLOSED" indicates that there is no fault.                                                                                      |
|                      |                             | TamperedStatus               | Switch, Contact          | accessory tampered status. A status of "ON"/"OPEN" indicates that the accessory has been tampered with. Value should return to "OFF"/"CLOSED" when the accessory has been reset to a non-tampered state.                                                                                                  |
...
|                      | SmokeDetectedState          |                              | SwitchItem, Contact  | Smoke sensor state (ON=smoke detected, OFF=no smoke)                                                                                                                                                                                                                                                      |
|                      |                             | Name                         | String                   | Name of the sensor                                                                                                                                                                                                                                                                                        |
|                      |                             | ActiveStatus                 | Switch, Contact          | accessory current working status. A value of "ON"/"OPEN" indicate that the accessory is active and is functioning without any errors.                                                                                                                                                                     |
|                      |                             | FaultStatus                  | Switch, Contact          | accessory fault status.  "ON"/"OPEN" value indicates that the accessory has experienced a fault that may be interfering with its intended functionality. A value of "OFF"/"CLOSED" indicates that there is no fault.                                                                                      |
|                      |                             | TamperedStatus               | Switch, Contact          | accessory tampered status. A status of "ON"/"OPEN" indicates that the accessory has been tampered with. Value should return to "OFF"/"CLOSED" when the accessory has been reset to a non-tampered state.                                                                                                  |
...
| Window               |                             |                              |                          | motorized window.                                                                                                                                                                                               |
|                      | CurrentPosition             |                              | Number, Dimmer, Rollershutter            | Current position of window. HomeKit expects 0 for closed, 100 for open. If device opposite values, the configuration [inverted="true"] can be used. This configuration will also apply for target position.                                                                                                                                                                                                                                                                        |
|                      | TargetPosition              |                              | Number, Dimmer, Rollershutter            | Target position of window                                                                                                                                                                                                                                                                         |
|                      | PositionState               |                              | String            | Current window state, possible values (DECREASING,INCREASING,STOPPED). Mapping can be redefined at item level, e.g. [DECREASING="CLOSING", INCREASING="OPENING"]                                                                                                                                                                                                                                                                         |
|                      |                             | Name                         | String                   | Name of the window                                                                                                                                                                                                                                                                               |
|                      |                             | HoldPosition                 | Switch                   | Window must stop at its current position (ON = window must stop. OFF = ignored.                                                                                                                                                                |
|                      |                             | ObstructionStatus            | Switch, Contact          | Current status of obstruction sensor. ON-obstruction detected, OFF - no obstruction                                                                                                                                                                                                                       |
...
|                      |                             | SwingMode                    | Number,Switch        | swing mode.  values: 0/OFF=SWING DISABLED, 1/ON=SWING ENABLED                                                                                                                                                                                                                                             |
|                      |                             | LockControl                  | Number,Switch        | status of physical control lock.  values: 0/OFF=CONTROL LOCK DISABLED, 1/ON=CONTROL LOCK ENABLED                                                                                                                                                                                                          |
| Slat                 |                             |                              |                          | Slat. additional configuration: slatType = ["HORIZONTAL", "VERTICAL"]                                                                                                                                                                                                                                                                                                    |
|                      |  CurrentSlatState           |                              | String                   | current slat state (FIXED, JAMMED, SWINGING). Mapping can be redefined at item level, e.g. [FIXED="FIX"] .                                                                                                                                                                                                                                            |
|                      |                             | Name                         | String                   | Name of the slat                                                                                                                                                                                                                                                                                         |
|                      |                             | SwingMode                    | Number,Switch        | swing mode.  values: 0/OFF=SWING DISABLED, 1/ON=SWING ENABLED                                                                                                                                                                                                                                             |
|                      |                             | TargetTiltAngle              | Number                   | target angle of slats                                                                                                                                                                                                                                                                          |
|                      |                             | CurrentTiltAngle             | Number                   | current angle of slats                                                                                                                                                                                                                                                                           |
...
|                      |                             | CurrentRelativeHumidity      | Number                   | current relative humidity in % between 0 and 100. additional configuration [multiplier = <number to multiply result with>].                                                                                                                                                                               |
|                      |                             | TargetRelativeHumidity       | Number                   | target relative humidity in % between 0 and 100. additional configuration [multiplier = <number to multiply result with>].                                                                                                                                                                               |
...
|                      |                             | LockTargetState              | Switch                   | target states of lock mechanism (OFF=SECURED, ON=UNSECURED)                                                                                                                                                                                                                                               |
| Door                 |                             |                              |                          | motorized door.                                                                                                                                                                                               |
|                      | CurrentPosition             |                              | Number, Dimmer, Rollershutter            | Current position of door. HomeKit expects 0 for closed, 100 for open. If device opposite values, the configuration [inverted="true"] can be used. This configuration will also apply for target position.                                                                                                                                                                                                                                                                        |
|                      | TargetPosition              |                              | Number, Dimmer, Rollershutter            | Target position of door                                                                                                                                                                                                                                                                         |
|                      | PositionState               |                              | String            | Current window state, possible values (DECREASING,INCREASING,STOPPED). Mapping can be redefined at item level, e.g. [DECREASING="CLOSING", INCREASING="OPENING"]                                                                                                                                                                                                                                                                         |
|                      |                             | Name                         | String                   | Name of the door                                                                                                                                                                                                                                                                               |
|                      |                             | HoldPosition                 | Switch                   | Вoor must stop at its current position (ON = window must stop. OFF = ignored.                                                                                                                                                                |
|                      |                             | ObstructionStatus            | Switch, Contact          | Current status of obstruction sensor. ON-obstruction detected, OFF - no obstruction                                                                                                                                                                                                                       |
