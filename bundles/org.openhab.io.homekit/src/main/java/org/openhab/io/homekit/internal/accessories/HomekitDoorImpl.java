 ...
 */
public class HomekitDoorImpl extends AbstractHomekitAccessoryImpl implements DoorAccessory {
    private final Logger logger = LoggerFactory.getLogger(HomekitDoorImpl.class);
    ...
    public HomekitDoorImpl(HomekitTaggedItem taggedItem, List<HomekitTaggedItem> mandatoryCharacteristics,
        ...
        final String invertedConfig = getAccessoryConfiguration(CURRENT_POSITION, CONFIG_INVERT, "false");
        inverted = invertedConfig.equalsIgnoreCase("yes") || invertedConfig.equalsIgnoreCase("true") ? 1 : 0;
        this.getServices().add(new DoorService(this));
    }
